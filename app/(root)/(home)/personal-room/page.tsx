...
const PersonalRoom = () => {
  ...
  const meetingLink = `${process.env.NEXT_PUBLIC_BASE_URL}/meeting/${meetingId}?OwnClassRoom?personal=true`
  ...
  const startRoom = async () => {
    ...
    router.push(`/meeting/${meetingId}?OwnClassRoom?personal=true`)
    }
